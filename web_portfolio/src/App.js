...
import Rtinder_02 from "./img/Rtinder_02.png"
...
function App() {
	...
	let rtinder_img=[Rtinder_01,Rtinder_02]
	let rtinder_about = "Your group cant decide where to eat, try Restaurant Tinder! A web app created by a small team that utilizes the yelp api to generate restaurants based off your group's preferences. Send them a unique link and swipe(click) on restaurants you like! Every round the restaurants with the least amount of likes will get eliminated until there is only one remaining!"
